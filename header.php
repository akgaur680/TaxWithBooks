    ...
    <div class="container-fluid">
        <header class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto  mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle " href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-brands fa-usps fa-lg" style="color: #ffffff;"></i>&nbsp;<span>Services</span></a>
                                <ul class="dropdown-menu">
                                    <li> <a class="dropdown-item" href="#">GST Returns</a> </li>
                                    <li> <a class="dropdown-item" href="#">Income Tax Returns</a> </li>
                                    <li> <a class="dropdown-item" href="#">TDS Returns</a> </li>
                                </ul>
                            </li>
                            <li class="nav-item">
            ...
            <div class="container box">
                <strong>
                    <marquee width="100%" direction="left" height="auto">To File Income Tax Returns, TDS Returns & Other Accounting Services. Please Contact on +91&nbsp;9877442467&nbsp;(Vijay&nbsp;Kumar&nbsp;Gaud)</marquee>
                </strong>
            </div>
        </header>
        <!-- Header Ends Here -->